...
function displayProductDetails(product) {
    ...
    if (document.getElementById('productImage')) document.getElementById('productImage').src = product.image;
    
    // Update product name
    if (document.getElementById('productName')) document.getElementById('productName').textContent = product.name;
    
    // Update product price
    if (document.getElementById('productPrice')) document.getElementById('productPrice').textContent = product.price;
    
    // Update product description
    if (document.getElementById('productDescription')) document.getElementById('productDescription').textContent = product.description;
    
    // Update product category
    if (document.getElementById('productCategory')) document.getElementById('productCategory').textContent = product.category;
    
    // Update product material
    if (document.getElementById('productMaterial')) document.getElementById('productMaterial').textContent = product.material;
    
    // Update product size options
    if (document.getElementById('productSize')) document.getElementById('productSize').textContent = product.size;
    
    // Update stock status
    if (document.getElementById('productStock')) document.getElementById('productStock').textContent = product.stock;
